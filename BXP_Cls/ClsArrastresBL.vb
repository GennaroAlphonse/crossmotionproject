Public Class ClsArrastresBL

    Public Property vid_num As String
    Public Property vAGENT As String
    ...
    Public Property v20GP As String
    Public Property v40GP As String
    Public Property v40HQ As String
    Public Property vEQUIPMENT As String
    Public Property vMODE As String
    Public Property vSINGLE As String
    ...
    Public Property vUN As String
    Public Property vRA As String
